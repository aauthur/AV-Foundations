...
export default function MultipleChoice({
  ...
  useEffect(() => {
    ...
    if (saved && typeof saved.selected_index === "number") {
      setSelectedIndex(saved.selected_index);
    }
  ...
  }, [assessment, questionId, selectedIndex, answerIsCorrect]);
  ...
  useEffect(() => {
    ...
    if (inAssessmentMode && selectedIndex === null) return;
        ...
        >
          <button
            ...
            style={{
              ...
              color: selectedIndex === null ? "#6f6252" : "#fffaf2",
              fontWeight: 700,
